...
class MyAppm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home:  Multipleselection(title: 'multilpe',),
...
class Multipleselection extends StatefulWidget {
  Multipleselection({super.key, required this.title});
  final String title;
  @override
          ...
          child: Column(
            children: <Widget>[
              ...
              MultiSelectBottomSheetField<Animal?>(
                ...
                onConfirm: (values) {
                  setState(() {
                    _selectedAnimals3 = values as List<Animal>;
                  });
              ...
              MultiSelectChipField<Animal?>(
                ...
                onTap: (values) {
                  _selectedAnimals4 = values as List<Animal>;
                  print(values);
                },
              ),
              SizedBox(height: 40),
