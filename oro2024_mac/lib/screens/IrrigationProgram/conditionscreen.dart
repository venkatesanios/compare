...
import 'package:oro2024_mac/model/IrrigationProgramModel/condition_model.dart';
import 'package:oro2024_mac/screens/IrrigationProgram/conditionwebui.dart';
...
import 'package:oro2024_mac/utils/widgets/SCustomWidgets/Alert_message.dart';
               ...
               Padding(
                 ...
                 child: SingleChildScrollView(
                  ...
                  //  Card(child: ListTile(title: Text('test',softWrap: true,),trailing: Text(_conditionModel.data!.conditionLibrary![i].conditionIsTrueWhen.toString(),softWrap: true,),)),
                   ...
                   Card(child: ListTile(title: Text('When Program',softWrap: true,),trailing:  DropdownButton(
                  ...
                  Card(child: ListTile(title: Text('Values'),trailing: Container(
                     height: 40,
                        width: 200,
                    child: TextFormField(
