...
class ControllerDashboardScreen4 extends StatefulWidget {
  const ControllerDashboardScreen4({super.key});

  @override
  State<ControllerDashboardScreen4> createState() => _ControllerDashboardScreen4State();
}

class _ControllerDashboardScreen4State extends State<ControllerDashboardScreen4> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: pumpOrderedKeys.length,
                        itemBuilder: (context, index) {
                          String key = pumpOrderedKeys[index];
                          String? value;

                          if (waterPumps.containsKey(key)) {
                            value = waterPumps[key];

                            bool isActiveWaterPump = activeWaterPumps.contains(
                                key);

                            return buildAvatarColumn(isActiveWaterPump, value, key, context);
                          }
                        }
                      ),
                    ),
